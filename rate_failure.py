...
df_rate.to_excel(writer,header=rate_header,sheet_name='work_rate',index=False)
df_failure.to_excel(writer,header=failure_header,sheet_name='work_failure',index=False)
writer.save()
writer.close()
